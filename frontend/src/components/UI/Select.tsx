...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className="select-scroll-button__icon" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className="select-scroll-button__icon" />
  </SelectPrimitive.ScrollDownButton>
));
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    ...
    >
      ...
      <SelectPrimitive.Viewport className={`select-viewport ${position === "popper" ? "select-viewport--popper" : ""}`}>
        {children}
